 ...
 *
 */
public class geeks extends BOYS{
	/**
	 ...
	 */
	public geeks(String nb,int arb,int rich,int intel,String sta,int areq,String type) {
    ...
    public double boyhappiness(GIRLS gf) {
        ...
        this.boy_happiness = gf.getGirl_intelg();
        return gf.getGirl_intelg();
    }
    /**
    ...
    public int calculate_giftspent(Gifttogirl [] gift, int totalgift, int require) {
        ...
        if(balance-gift[totalgift].gift_price>=0) {
        	balance = balance-gift[totalgift].gift_price;
            totalgift++;
        }
